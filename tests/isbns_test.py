import random
import unittest
from isbn.rest import isbn_parse, is_valid
...
class TestIsbn(unittest.TestCase):
    ...
    def test_is_valid_rnd(self):
        invalids = (random.randint(0, 999999999), random.randint(10000000000, 999999999999),
                    random.randint(10000000000000, 9999999999999999))
        for x in invalids:
